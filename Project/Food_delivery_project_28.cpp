...
void add_restaurent_details()
{
    ...
    cout<<"Cuisine type=";
    getline(cin,type);
    cout << "Restaurant details added successfully!" << endl;
    r++;
}
void view_restaurant_details()
{
...
void view_history()
{
   cout<<"List of Customers visited till now:"<<endl;
   if (totalusers==0)
   {
     cout<<"empty"<<endl;
     return;
